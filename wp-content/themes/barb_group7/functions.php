...
function barb_scripts()
{
    ...
    wp_enqueue_script('bootstrap', get_template_directory_uri() . '/plugins/bootstrap/js/bootstrap.min.js', array('popper'), '4.3.0', true);
    //Wow Animation
...
//    //Contacts
//    wp_enqueue_script('contacts', get_template_directory_uri() . '/plugins/form/contact.js', array('jquery'), '1.0.0', true);
}
