                ...
                <div class="row">
                    <div class="col-lg-8 m-auto text-center col-sm-12 col-md-12">
                        <div class="banner-content content-padding">
                            ...
                            <p>
                                К нам обращаются, когда нужно создать лендинг под новый товар или услугу, еще, если
                                нужно продвинуть
                ...
                <div class="row">
                    <div class="col-lg-6 col-sm-6 col-md-6">
                        <div class="intro-box">
                            ...
                            <h4>Проекты</h4>
                            <p>
                                мы ведем каждый проект индивидуально, за вами закрепляется менеджер, который работает
                                только с вами.
                            </p>
                        </div>
                    </div>
                    <div class="col-lg-6 col-sm-6 col-md-6">
                        <div class="intro-box">
                            ...
                            <h4>Стратегия</h4>
                            <p>
                                не беремся за проект, если он одноразовый, запускаем такие проекты, с которыми будем
                                работать
                                несоклько лет.
                            </p>
                        </div>
                    ...
                    <div class="col-lg-6 col-sm-6 col-md-6">
                        <div class="intro-box">
                            ...
                            <h4>Опыт</h4>
                            <p>
                                мы успели поработать в разных нишах: строительство, инвестиции, онлайн-образование,
                                бьюти-сфера и
                                другие.
                            </p>
                        </div>
                    ...
                    <div class="col-lg-6 col-sm-6 col-md-6">
                        <div class="intro-box">
                            ...
                            <h4>Технологии</h4>
                            <p>
                                Все проекты делает команда разработчиков, которая постоянно учится новому, мы используем
                                современные
        ...
        <div class="row">
            <div class="col-lg-7 col-sm-12 col-md-8">
                <div class="about-content">
                    ...
                    <p>
                        Мы создадим сайт про вашу компанию и вам не придется заказывать услуги у фрилансеров, переживая
                        за сроки
            ...
            <div class="col-lg-4 col-sm-6 col-md-6">
                <div class="service-box">
                    ...
                    <div class="service-inner">
                        ...
                        <p>
                            Охватите огромное количество пользователей и получите рекламу вашего продукта и услуги с
                            помощью
            ...
            <div class="col-lg-4 col-sm-6 col-md-6">
                <div class="service-box">
                    ...
                    <div class="service-inner">
                        ...
                        <p>
                            Маркетинг по электронной почте-это отличное решение для охвата широкого круга клиентов, с
                            нетерпением
            ...
            <div class="col-lg-4 col-sm-6 col-md-6">
                <div class="service-box">
                    ...
                    <div class="service-inner">
                        ...
                        <p>
                            мы предоставляем широкий спектр услуг seo, чтобы выдвинуть ваш сайт в топ по запросам, чтобы
                            охватить
            ...
            <div class="col-lg-4 col-sm-6 col-md-6">
                <div class="service-box">
                    ...
                    <div class="service-inner">
                        ...
                        <p>
                            Мы предоставляем индивидуальный веб-сайт для любого веб-сервиса небольшой и крупной компании
                            в большом
                            компактном пакете.
                        </p>
                    </div>
            ...
            <div class="col-lg-4 col-sm-6 col-md-6">
                <div class="service-box">
                    ...
                    <div class="service-inner">
                        ...
                        <p>
                            Создайте информационный сайт, чтобы заработать на нем, а мы вам в этом поможем: с помощью
                            дизайна,
                            разработки или SEO.
                        </p>
                    </div>
            ...
            <div class="col-lg-4 col-sm-6 col-md-6">
                <div class="service-box">
                    ...
                    <div class="service-inner">
                        ...
                        <p>
                            Чтобы ваш сайт вызывал больше доверия, мы обеспечим высокую цитируемость. На ваш сайт будут
                            ссылаться
                            авторитетные сайты.
                        </p>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12 col-sm-12">
                                    <div class="testimonial-content style-2">
                                        ...
                                        <p>
                                            <i class="icofont icofont-quote-left"></i>Это отличная платформа для тех,
                                            кто хочет начать
                                            бизнес, но не может принять правильное решение. Это действительно отличное
                                            место для того,
                                            чтобы начать свой бизнес правильно! <i
            ...
            <div class="col-lg-4 col-sm-6 col-md-4">
                <div class="blog-block">
                    ...
                    <div class="blog-text">
                        ...
                        <a href="blog-single.html" class="h5 my-2 d-inline-block"> Лучшие способы вовлечь людей в
                            статью </a>
                        <p>Вы заметили, что статьи на вашем сайте даже не читают? Это можно легко исправить, вам
                            поможет...</p>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 col-md-4">
                <div class="blog-block">
                    ...
                    <div class="blog-text">
                        ...
                        >
                        <p>
                            Позиционирование. Вот, что нужно для быстрого поднятия сайта в топ, ну и поведенческие
                            факторы,
            ...
            <div class="col-lg-4 col-sm-6 col-md-4">
                <div class="blog-block">
                    ...
                    <div class="blog-text">
                        ...
                        <p>
                            Даже если ваш сайт еще только в вашей голове или на бумаге, его можно запустить всего за
                            сутки.
